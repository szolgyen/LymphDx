...
class OutlinesDecoder(BaseDecoder):
    ...
    def validate_ready(self) -> None:
        ...
        if not self._allowed_diagnoses:
            raise ValueError(
                "decoder='outlines' requires non-empty allowed_diagnoses for strict constraints"
            )
    ...
    def _build_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                ...
                "is_lymph_node": {"anyOf": [{"type": "boolean"}, {"type": "null"}]},
                "anatomic_location": {"anyOf": [{"type": "string"}, {"type": "null"}]},
